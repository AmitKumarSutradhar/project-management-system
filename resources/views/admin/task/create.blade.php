...
@section('body')
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <div class="">
            <a href="{{ route('admin.task.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-arrow-right fa-sm text-white-50"></i> All Tasks</a>
        </div>
    </div>
